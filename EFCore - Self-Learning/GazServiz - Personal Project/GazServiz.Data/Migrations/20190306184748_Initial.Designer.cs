...
namespace GazServiz.Data.Migrations
{
    ...
    [Migration("20190306184748_Initial")]
            ...
            modelBuilder.Entity("GazServiz.Models.Repair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RepairId = 1,
                            CarId = 1,
                            DateIn = new DateTime(2019, 3, 6, 20, 47, 44, 581, DateTimeKind.Local).AddTicks(3874),
                            EmployeeId = 5,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 2,
                            CarId = 4,
                            DateIn = new DateTime(2019, 3, 6, 20, 47, 44, 596, DateTimeKind.Local).AddTicks(9727),
                            EmployeeId = 2,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 3,
                            CarId = 2,
                            DateIn = new DateTime(2019, 3, 6, 20, 47, 44, 596, DateTimeKind.Local).AddTicks(9912),
                            EmployeeId = 1,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 4,
                            CarId = 11,
                            DateIn = new DateTime(2019, 3, 6, 20, 47, 44, 596, DateTimeKind.Local).AddTicks(9989),
                            EmployeeId = 3,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 5,
                            CarId = 8,
                            DateIn = new DateTime(2019, 3, 6, 20, 47, 44, 597, DateTimeKind.Local).AddTicks(15),
                            EmployeeId = 6,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 6,
                            CarId = 7,
                            DateIn = new DateTime(2019, 3, 6, 20, 47, 44, 597, DateTimeKind.Local).AddTicks(66),
                            EmployeeId = 4,
                            IsFixed = false,
