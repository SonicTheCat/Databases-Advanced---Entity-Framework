...
namespace GazServiz.Data.Migrations
{
    ...
    [Migration("20190306185923_BoolToString")]
            ...
            modelBuilder.Entity("GazServiz.Models.Repair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RepairId = 1,
                            CarId = 1,
                            DateIn = new DateTime(2019, 3, 6, 20, 59, 20, 187, DateTimeKind.Local).AddTicks(7364),
                            EmployeeId = 5,
                            IsFixed = "Nope",
                        ...
                        new
                        {
                            RepairId = 2,
                            CarId = 4,
                            DateIn = new DateTime(2019, 3, 6, 20, 59, 20, 199, DateTimeKind.Local).AddTicks(4559),
                            EmployeeId = 2,
                            IsFixed = "Nope",
                        ...
                        new
                        {
                            RepairId = 3,
                            CarId = 2,
                            DateIn = new DateTime(2019, 3, 6, 20, 59, 20, 199, DateTimeKind.Local).AddTicks(4693),
                            EmployeeId = 1,
                            IsFixed = "Nope",
                        ...
                        new
                        {
                            RepairId = 4,
                            CarId = 11,
                            DateIn = new DateTime(2019, 3, 6, 20, 59, 20, 199, DateTimeKind.Local).AddTicks(4724),
                            EmployeeId = 3,
                            IsFixed = "Nope",
                        ...
                        new
                        {
                            RepairId = 5,
                            CarId = 8,
                            DateIn = new DateTime(2019, 3, 6, 20, 59, 20, 199, DateTimeKind.Local).AddTicks(4744),
                            EmployeeId = 6,
                            IsFixed = "Nope",
                        ...
                        new
                        {
                            RepairId = 6,
                            CarId = 7,
                            DateIn = new DateTime(2019, 3, 6, 20, 59, 20, 199, DateTimeKind.Local).AddTicks(4770),
                            EmployeeId = 4,
                            IsFixed = "Nope",
