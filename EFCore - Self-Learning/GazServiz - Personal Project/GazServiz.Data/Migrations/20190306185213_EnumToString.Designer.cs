...
namespace GazServiz.Data.Migrations
{
    ...
    [Migration("20190306185213_EnumToString")]
            ...
            modelBuilder.Entity("GazServiz.Models.Repair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RepairId = 1,
                            CarId = 1,
                            DateIn = new DateTime(2019, 3, 6, 20, 52, 9, 654, DateTimeKind.Local).AddTicks(4905),
                            EmployeeId = 5,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 2,
                            CarId = 4,
                            DateIn = new DateTime(2019, 3, 6, 20, 52, 9, 667, DateTimeKind.Local).AddTicks(4187),
                            EmployeeId = 2,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 3,
                            CarId = 2,
                            DateIn = new DateTime(2019, 3, 6, 20, 52, 9, 667, DateTimeKind.Local).AddTicks(4377),
                            EmployeeId = 1,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 4,
                            CarId = 11,
                            DateIn = new DateTime(2019, 3, 6, 20, 52, 9, 667, DateTimeKind.Local).AddTicks(4418),
                            EmployeeId = 3,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 5,
                            CarId = 8,
                            DateIn = new DateTime(2019, 3, 6, 20, 52, 9, 667, DateTimeKind.Local).AddTicks(4438),
                            EmployeeId = 6,
                            IsFixed = false,
                        ...
                        new
                        {
                            RepairId = 6,
                            CarId = 7,
                            DateIn = new DateTime(2019, 3, 6, 20, 52, 9, 667, DateTimeKind.Local).AddTicks(4777),
                            EmployeeId = 4,
                            IsFixed = false,
